    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="name form-control" aria-describedby="rankHelp">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="Updatename" id="Updatename" class="Updatename form-control" aria-describedby="rankHelp">
                    <input type="hidden" name="update_id" id="update_id" class="update_id form-control" aria-describedby="rankHelp">
...
{{--update modal end --}}
 ...
 {{-- search bar start here --}}
        ...
        <div class="input-group">
            <input type="search" width="100px" id="search_content_unit" class="form-control rounded" placeholder="لطفا قطعه مورد نظر تان را اینجا جستجو نماید..." />
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function (key, item) {
                            $('tbody').append('<tr><td>'
                                ...
                                '</td><td>'
                                +item.name+
                                '</td><td><button type="button" value="'+item.id+'" class="updatBtn btn btn-info">Update</button>'+
                              '</td><td><button "type="button" value="'+item.id+'" class="deleteBtn btn btn-danger" >Delete</button></td></tr>'
