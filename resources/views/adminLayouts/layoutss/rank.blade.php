        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="updateId" id="updateId" class="updateId form-control" aria-describedby="rankHelp">
                    </div>
...
{{-- card an table start --}}
    ...
    {{-- <div class="container"> --}}
        <div class="input-group">
            <input type="search" width="100px" id="search_content_rank" class="form-control rounded" placeholder="لطفا رتبه مورد نظر تان را اینجا جستجو نماید..." />
