...
Route::middleware(['auth'])->group(function () {
        ...
        Route::middleware(['role:admin'])->group(function () {
                ...
                Route::get('/role_info/{id?}', [RollController::class, 'roleInfo'])->name('role.info');
                Route::post('/role_givePermission', [RollController::class, 'givePermission'])->name('role.createPermission');
                // Route::get('/role_givePermission/{id?}',[RollController::class,'getPermissions'])->name('role.getRolePermissions');
                Route::delete('/role_removePermission', [RollController::class, 'removePermission'])->name('role.removePermission');

                Route::get('/backToRole', [RollController::class, 'backToRole'])->name('user.backToRole');
